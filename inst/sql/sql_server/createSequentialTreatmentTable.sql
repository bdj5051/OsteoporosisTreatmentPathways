...
FROM (
		...
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND SUBJECTS.SECOND_COMBO IS NULL
	) T1,
...
FROM (
		...
		JOIN @cdmDatabaseSchema.OBSERVATION_PERIOD OP
		ON SUBJECTS.SUBJECT_ID=OP.PERSON_ID
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND SUBJECTS.SECOND_COMBO IS NOT NULL AND cast(SUBJECTS.SECOND_COMBO as int) IN (1,2,4,8,16,32,64)
	) T1,
	(SELECT *, RIGHT(cast(COHORT_DEFINITION_ID as varchar(5)), 1) AS DRUG_ID FROM @cohortDatabaseSchema.@cohortTable_DRUG) T2
...
FROM (
		...
		JOIN @cdmDatabaseSchema.OBSERVATION_PERIOD OP
		ON SUBJECTS.SUBJECT_ID=OP.PERSON_ID
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND SUBJECTS.SECOND_COMBO IS NOT NULL AND cast(SUBJECTS.SECOND_COMBO as int) NOT IN (1,2,4,8,16,32,64)
	) T1,
	(SELECT *, RIGHT(cast(COHORT_DEFINITION_ID as varchar(5)), 1) AS DRUG_ID FROM @cohortDatabaseSchema.@cohortTable_DRUG) T2
WHERE T1.SUBJECT_ID = T2.SUBJECT_ID AND T2.COHORT_START_DATE >= T1.LINE_START_DATE AND T2.COHORT_START_DATE <= T1.LINE_END_DATE  AND T1.COHORT_ID=T2.DRUG_ID;
...
FROM (
		...
		JOIN @cdmDatabaseSchema.OBSERVATION_PERIOD OP
		ON SUBJECTS.SUBJECT_ID=OP.PERSON_ID
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND SUBJECTS.THIRD_COMBO IS NULL
	) T1,
	(SELECT *, RIGHT(cast(COHORT_DEFINITION_ID as varchar(5)), 1) AS DRUG_ID FROM @cohortDatabaseSchema.@cohortTable_DRUG) T2
...
FROM (
		...
		JOIN @cdmDatabaseSchema.OBSERVATION_PERIOD OP
		ON SUBJECTS.SUBJECT_ID=OP.PERSON_ID
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND cast(SUBJECTS.SECOND_COMBO as int) IN (1,2,4,8,16,32) AND SUBJECTS.THIRD_COMBO IS NOT NULL
	) T1,
	(SELECT *, RIGHT(cast(COHORT_DEFINITION_ID as varchar(5)), 1) AS DRUG_ID FROM @cohortDatabaseSchema.@cohortTable_DRUG) T2
...
FROM (
		...
		JOIN @cdmDatabaseSchema.OBSERVATION_PERIOD OP
		ON SUBJECTS.SUBJECT_ID=OP.PERSON_ID
		WHERE COHORTS.COHORT_DEFINITION_ID IN (1001,1002,1003,1004,1005) AND cast(SUBJECTS.SECOND_COMBO as int) NOT IN (1,2,4,8,16,32) AND SUBJECTS.THIRD_COMBO IS NOT NULL
	) T1,
	(SELECT *, RIGHT(cast(COHORT_DEFINITION_ID as varchar(5)), 1) AS DRUG_ID FROM @cohortDatabaseSchema.@cohortTable_DRUG) T2
WHERE T1.SUBJECT_ID = T2.SUBJECT_ID AND T2.COHORT_START_DATE >= T1.LINE_START_DATE AND T2.COHORT_START_DATE <= T1.LINE_END_DATE;
